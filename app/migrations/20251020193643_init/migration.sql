...
-- CreateIndex
CREATE UNIQUE INDEX "Car_handle_key" ON "Car"("handle");

-- CreateIndex
CREATE UNIQUE INDEX "CarRental_sessionId_key" ON "CarRental"("sessionId");
...
-- AddForeignKey
ALTER TABLE "CarRental" ADD CONSTRAINT "CarRental_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
