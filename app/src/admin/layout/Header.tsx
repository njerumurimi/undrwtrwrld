                    ...
                    >
                        <span className="h-5.5 w-5.5 relative block cursor-pointer">
                            <span className="du-block absolute right-0 h-full w-full">
                                <span
                                    className={cn(
                                        "bg-foreground relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm [transition-delay:0ms] duration-200 ease-in-out",
                                        {
                            ...
                            <span className="absolute right-0 h-full w-full rotate-45">
                                <span
                                    className={cn(
                                        ...
                                        {
                                            "!h-0 [transition-delay:0ms]": !props.sidebarOpen,
                                        },
                                    )}
                                ></span>
                                <span
                                    className={cn(
                                        ...
                                        {
                                            "!h-0 [transition-delay:200ms]": !props.sidebarOpen,
                                        },
                                    )}
                                ></span>
                            </span>
